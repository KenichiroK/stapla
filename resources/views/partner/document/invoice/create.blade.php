				...
				<table>
					...
					<tbody id="taskRequest">
						...
						<tr>
							...
							@endif
							<td class="item">
								<input type="text" value="{{ old('item_name.' . $i, $task->PurchaseOrder->task_name) }}" disabled="disabled">
								<input type="hidden" name="item_name[]" value="{{ old('item_name.' . $i, $task->PurchaseOrder->task_name) }}">
							</td>
