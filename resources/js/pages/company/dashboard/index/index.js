...
elementObject.projectMoreBtn.addEventListener("click", () => {
  projectDefaultShowNum = clickMoreBtn(
    projectDefaultShowNum,
    projectMoreShowNum,
    elementObject.projects,
    elementObject.projectMoreBtnElement,
  );
});
...
window.onload = () => {
  ...
  showDefaultElement(projectDefaultShowNum, elementObject.projects, elementObject.projectMoreBtnElement);
